const CONFIG = {
    ...
    contactEmail: "contact@novastudios.com",
    socials: {
    ...
    portfolio: [
        {
            ...
            link: "#",
            fullDescription: "This is just a example we made. Your order will be custom just for you! You can change anything you want.",
            media: [
        ...
        },
        {
            ...
            link: "#",
            fullDescription: "Vibe Journal is an AI-powered journaling app that helps you track your mood and habits.",
            media: [
        ...
        },
        {
            ...
            link: "#",
            fullDescription: "A portfolio site we made for a client. This is just a example! We can make anything you want!",
            media: [
